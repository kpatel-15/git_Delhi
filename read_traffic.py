...
hp.to_csv(f, mode='w', header=True)
f.close()
...
#df_shp = hourly_avg[['item_code','item_description','item_length', 'coordinates']]
#df_shp.set_index('coordinates', inplace=True)
#df_shp.drop_duplicates(inplace=True)
#df_shp['coordinates'] = df_shp.index
#df_shp.to_csv(sourcepath + '/bing_shape.csv')
